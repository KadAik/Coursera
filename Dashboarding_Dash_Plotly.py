...
# Callbacks
# - Callback to disable year input if year statistic is selected
    ...
    if stat == "Recession Period Statistics":
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                ...
                names='Vehicle_Type',
                title="Advertisement Expenditure per Vehicle Type"
            )
        )
    ...
    # Yearly Statistic Report Plots                             
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(mas,
                x='Month',
                y='Automobile_Sales',
                title='Monthly Automobile Sales in the year {}'.format(year)
            )
        )
        ...
        Y_chart4 = dcc.Graph(
            figure = px.pie(exp_data,
                values='Advertising_Expenditure',
                names='Vehicle_Type',
                title='Advertising Expenditure per vehicle in the year {}'.format(year)
            )
        )
